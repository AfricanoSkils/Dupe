...
frameBoas.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
...
titulo.Text = "👑 BEM-VINDO AO AIM VIP"
...
mensagem.Text = "💰 O melhor painel premium do Roblox.\n🔑 Pegue sua key no Discord!"
...
frameKey.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
